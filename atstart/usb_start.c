...
static uint8_t single_desc_bytes_cdc[] = {
    /* Device descriptors and Configuration descriptors list. */
    CDCD_ACM_DESCES_LS_FS};
#define CDCD_ECHO_BUF_SIZ CONF_USB_CDCD_ACM_DATA_BULKIN_MAXPKSZ

static struct usbd_descriptors single_desc_cdc[]
    = {{single_desc_bytes_cdc, single_desc_bytes_cdc + sizeof(single_desc_bytes_cdc)}
};
...
static uint8_t single_desc_bytes_msc[] = {
    /* Device descriptors and Configuration descriptors list. */
    MSC_DESCES_LS_FS};

static struct usbd_descriptors single_desc_msc[]
    = {{single_desc_bytes_msc, single_desc_bytes_msc + sizeof(single_desc_bytes_msc)}
};
